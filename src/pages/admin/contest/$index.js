...
import { Table, Divider, Tag, Button, Pagination, Input, message, Icon, Popconfirm, Modal, Form, Select, DatePicker } from 'antd'
...
class Index extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <div>
                    <Button type='primary' onClick={this.showModal}>添加比赛</Button>
                    <Table
                        pagination={false}
                        loading={loading}
                        columns={columns}
